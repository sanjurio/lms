...
def register_routes(app):
                ...
                if action == 'approve':
                    ...
                    if user:
                        ...
                        activity = UserActivity(
                            user_id=user_id,
                            activity_type='registration_approved',
                            activity_data=f"Approved by Admin ID: {current_user.id}"
                        )
    ...
    def admin_add_course():
        ...
        if form.validate_on_submit():
            course = Course(
                ...
                required_level=form.required_level.data
            )
    ...
    def admin_edit_course(course_id):
        ...
        if form.validate_on_submit():
            ...
            course.required_level = form.required_level.data
        ...
        form.required_level.data = course.required_level or 1
