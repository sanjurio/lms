...
def send_email_verification_otp(to_email, otp_code, username):
    ...
    subject = "Learning Platform - Verify Your Email Address"
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <p>Hello {username},</p>
                <p>Thank you for registering with Learning Platform. Please use the verification code below to confirm your email address:</p>
                <div class="otp-box">
                    <div class="otp-code">{otp_code}</div>
                </div>
                <p><strong>This code will expire in 10 minutes.</strong></p>
                <p>If you didn't create an account with Learning Platform, please ignore this email.</p>
                <p>Best regards,<br>LP Team</p>
            </div>
            <div class="footer">
    ...
    Thank you for registering with Learning Platform. Please use the verification code below to confirm your email address:
...
def send_mandatory_course_reminder_email(to_email, username, course_title, days_remaining, deadline):
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>Please log in to your Learning Platform account immediately to complete this mandatory course before the deadline.</p>
    ...
    Please log in to your Learning Platform account immediately to complete this mandatory course before the deadline.
...
def send_password_reset_email(to_email, otp_code, username):
    ...
    subject = "Learning Platform - Password Reset Code"
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <p>Hello {username},</p>
                <p>We received a request to reset your password for your Learning Platform account. Use the verification code below to reset your password:</p>
                <div class="otp-box">
                    <div class="otp-code">{otp_code}</div>
                </div>
                <p><strong>This code will expire in 10 minutes.</strong></p>
    ...
    We received a request to reset your password for your Learning Platform account.
...
def send_mandatory_course_email(to_email, username, course_title, deadline=None, assigned_by=None):
    ...
    subject = f"Learning Platform - New Mandatory Course Assigned: {course_title}"
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                {deadline_text}
                <p>Please log in to your Learning Platform account to access and complete this course.</p>
    ...
    Please log in to your Learning Platform account to access and complete this course.
